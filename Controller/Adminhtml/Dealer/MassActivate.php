...
class MassActivate extends \Magento\Backend\App\Action implements HttpPostActionInterface
{
    ...
    public function execute()
    {
        ...
        foreach ($collection as $dealer) {
            try {
                $dealer->setIsEnabled(DealerInterface::STATUS_ENABLED);
        ...
        if ($dealerActivated) {
            $this->messageManager->addSuccessMessage(__('A total of %1 record(s) have been activated.', $dealerActivated));
        }
